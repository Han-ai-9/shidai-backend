...
import com.han.shidai.mapper.TeamMapper;
import com.han.shidai.model.domain.User;
import com.han.shidai.model.domain.UserTeam;
import com.han.shidai.model.enums.TeamStatusEnum;
...
import com.han.shidai.model.vo.UserVO;
...
//        1.请求参数是否为空？
        ...
        //e.如果 status是加密状态，一定要有密码，且密码 <=32
...
//        5.插入用户 =>队伍关系到关系表
    ...
    public boolean updateTeam(TeamUpdateRequest teamUpdateRequest, User loginUser) {
        ...
        if (statusEnum.equals(TeamStatusEnum.SECRET) && teamUpdateRequest.getPassword() == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "加密房间要设置加密");
        }
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        if (userId == team.getUserId()) {
            throw new BusinessException(ErrorCode.NULL_ERROR, "不能加入自己的房间");
        }
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("shidai:join_team");
