package com.han.shidai.service.impl;
...
import static com.han.shidai.contant.UserConstant.ADMIN_ROLE;
import static com.han.shidai.contant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public List<User> searchUsersByTags(List<String> tagNameList) {
        ...
        //调用数据库需要时间
        //sql先 memory后 (sql 22 memory 35)
        //反过来 37 22
        List<User> list2 = memorySearch(tagNameList);
//        List<User> list1=sqlSearch(tagNameList);
        return list2;
     ...
     * @return
     */
    private List<User> memorySearch(List<String> tagNameList) {
