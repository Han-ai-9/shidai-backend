...
import com.han.shidai.model.request.UserLoginRequest;
import com.han.shidai.model.request.UserRegisterRequest;
...
public class UserController {
    ...
    public BaseResponse<List<User>> searchUsers(String username, HttpServletRequest request) {
        if (!userService.isAdmin(request)) {
            throw new BusinessException(ErrorCode.FORBIDDEN, "缺少管理员权限");
        }
    ...
    public BaseResponse<Page<User>> recommendUsers(long pageSize, long pageNum, HttpServletRequest request) {
        ...
        String key = SHIDAI_USER_RECOMMEND + loginUser.getId();
        //如果有缓存,直接缓存
        ...
        try {
            redisTemplate.opsForValue().set(key, userPage, 30000, TimeUnit.MILLISECONDS);
        } catch (Exception e) {
