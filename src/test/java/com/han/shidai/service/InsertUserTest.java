...
public class InsertUserTest {
    ...
    public void doInsertUser() {
        ...
        for (int i = 0; i < INSERT_NUM; i++) {
            ...
            user.setAvatarUrl("https://images.zsxq.com/Fgz3JDiGhpSGFkzfL27fQAU_aW1O?e=1725119999&token=kIxbL07-8jAj8w1n4s9zv64FuZZNEATmlU_Vm6zD:qmfYX4PEJ1subp8TuKbltAWZFh4=");
            user.setGender(0);
    ...
    public void doConcurrencyInsertUser() {
        ...
        for (int i = 0; i < INSERT_NUM/batchSize; i++) {
            ...
            while (true){
                ...
                user.setAvatarUrl("https://images.zsxq.com/FioWts-emoUJa81Qm1NjJbZFkGz4?e=1725119999&token=kIxbL07-8jAj8w1n4s9zv64FuZZNEATmlU_Vm6zD:L1n_GpyztUXHU3EpuyxpcaWpPO8=");
                user.setGender(0);
                user.setUserPassword("12345678");
